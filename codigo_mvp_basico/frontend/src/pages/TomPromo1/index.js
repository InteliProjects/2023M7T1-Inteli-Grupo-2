  ...
  */
  ...
  return (
    <div>
      ...
      <span className="bold-text">A partir de:</span> <span className="smaller-text">1x de</span> <span className="bold-price"><br />R$ <span className="larger-text">106,80</span></span>
    </div>
  ...
  <div className="additional-rectangle1">
        ...
        <div className="subtext">O básico para quem quer<br />começar a vender.</div>
        <div className="price-home">
      <span className="bold-text">A partir de:</span> <span className="smaller-text">2x de</span> <span className="bold-price"><br />R$ <span className="larger-text">53,40</span></span>
    </div>
    <div className="button-container" onClick={buyTon}>Contrate agora</div>
  </div>
  <div className="additional-rectangle1">
        ...
        <div className="subtext">O básico para quem quer<br />começar a vender.</div>
        <div className="price-home">
      <span className="bold-text">A partir de:</span> <span className="smaller-text">3x de</span> <span className="bold-price"><br />R$ <span className="larger-text">35,60</span></span>
    </div>
    <div className="button-container" onClick={buyTon}>Contrate agora</div>
  </div>      
